...
function shareText(score) {
    ...
    SubmitResults();
    if (score <= 19) return '“搞事被宿管抓走，扣分”<br/>你的得分为：';
    if (score <= 59) return '“三栋已成废墟[lay in ruins]”<br/>你的得分为：';
    if (score <= 109) return '“塔中已升天”<br/>你的得分为：';
    if (score <= 169) return '“从此再无大塘头村”<br/>你的得分为：';
